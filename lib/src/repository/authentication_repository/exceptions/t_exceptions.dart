...
class TExceptions implements Exception{
  ...
  const TExceptions([this.message = "An unknown message occured"]);
  ...
  factory TExceptions.fromCode(String code){
    switch (code){
      ...
      case "user-disabled":
        return const TExceptions('This user has been disabled. Please contact '
            'support for help');
      case "user-not-found":
      ...
      case "invalid-argument":
        return const TExceptions('An invalid argument was provided to an '
      ...
      case "operation-not-allowed":
        return const TExceptions('The provided Sign in provider is disabled for '
            'your Firebase project');
      case "session-cookie-expired":
        return const TExceptions('The provided Firebase session cookie is expired.');
      case "uid-already-exists":
        return const TExceptions('The provided uid is already in use by an existing '
            'user.');
