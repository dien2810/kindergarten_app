...
class ChiTietClbCardCuaToiScreen extends StatelessWidget {
  ...
  const ChiTietClbCardCuaToiScreen({Key? key, required this.backgroundImage}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildAlignedDetailRow('Ngày tham gia', participationDate),
              _buildAlignedDetailRow('Tình trạng thanh toán', paymentStatus),
