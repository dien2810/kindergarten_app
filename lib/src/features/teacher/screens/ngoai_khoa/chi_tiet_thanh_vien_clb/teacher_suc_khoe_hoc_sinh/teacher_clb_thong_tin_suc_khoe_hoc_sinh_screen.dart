...
import 'package:kindergarten_app/src/features/teacher/screens/ngoai_khoa/chi_tiet_thanh_vien_clb/teacher_suc_khoe_hoc_sinh/teacher_clb_thong_tin_suc_khoe_form_widget.dart';
import '../../../../../../constants/sizes.dart';
import '../../../../controllers/suc_khoe_hoc_sinh/teacher_suc_khoe_hoc_sinh_controller.dart';
import 'co_ban_tab/teacher_clb_co_ban_tab_widget.dart';
import 'ho_so_y_te/teacher_clb_danh_sach_lich_su_tiem_chung_widget.dart';
import 'ho_so_y_te/teacher_clb_loi_khuyen_bac_si_widget.dart';
import 'kham_tab/teacher_clb_kham_tab_widget.dart';


class TeacherClbThongTinSucKhoeHocSinhScreen extends StatelessWidget {
  final String studentName; // Tên học sinh
  final String imageUrl; // Đường dẫn ảnh của học sinh
  const TeacherClbThongTinSucKhoeHocSinhScreen({
    super.key,
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: NestedScrollView(
            ...
            body: TabBarView(
              children: [
                TeacherClbThongTinSucKhoeChungWidget(controller: controller),
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: TabBarView(
                          children: [
                            TeacherClbCoBanTabWidget(controller: controller),
                            TeacherClbKhamTabWidget(controller: controller),
                            TeacherClbLoiKhuyenBacSiWidget(controller: controller),
                            TeacherClbDanhSachLichSuTiemChungWidget(controller: controller),
                          ],
                        ),
                      ),
                    ],
