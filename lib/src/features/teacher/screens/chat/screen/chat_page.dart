...
import 'package:kindergarten_app/src/features/teacher/controllers/chat/teacher_chat_page_controller.dart';
...
class _ChatPageState extends State<ChatPage>{
  ...
  Widget _buildMessageList(){
    final chatPageController = Get.put(TeacherChatPageController());
