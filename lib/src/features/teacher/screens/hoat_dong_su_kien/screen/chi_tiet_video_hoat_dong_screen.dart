...
class TeacherVideoScreen extends StatefulWidget {
  final String videoLink;

  const TeacherVideoScreen({super.key, this.videoLink='https://www.youtube.com/watch?v=X0wxLzTe5rE'});

  @override
  _VideoScreenState createState() => _VideoScreenState();
}

class _VideoScreenState extends State<TeacherVideoScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: ()=>controller.uploadVideo(), // Gọi hàm upload video
