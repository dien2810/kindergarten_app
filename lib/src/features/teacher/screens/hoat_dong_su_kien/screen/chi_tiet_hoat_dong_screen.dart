...
class TeacherChiTietHoatDongScreen extends StatelessWidget {
  ...
  const TeacherChiTietHoatDongScreen({super.key, required this.typeOfActivity});
              ...
              children: [
                ...
                _buildCard(
                  children: [
                    ...
                    Text(activityEvent.activityName, style: _contentStyle),
                        ...
                        return ListTile(
                          ...
                          trailing: SizedBox(
                            child: ElevatedButton(
                              onPressed: () {
                                Get.to(() => TeacherHinhAnhScreen(images: activityEvent.image, screenType: tActivity));
                              },
                ...
                // // Ghi chú học sinh
                // _buildSectionTitle(tGHICHUHOCSINH),
                // _buildCard(
                //   children: [
                //     const Text(
                //       '$tHocSinh: Nguyễn Văn An',
